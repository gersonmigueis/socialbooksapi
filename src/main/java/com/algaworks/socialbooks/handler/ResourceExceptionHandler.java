...
public class ResourceExceptionHandler {
	...
	//tratando a existencia de um autor
	@ExceptionHandler(AutorExistenteExeception.class)
	public ResponseEntity<DetalhesErro> handlerAutorExistenteExeception
							(AutorExistenteExeception e, HttpServletRequest request){
